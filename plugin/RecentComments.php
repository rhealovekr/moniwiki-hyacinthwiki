...
// Public Domain ?
// $Id: RecentComments.php,v 1.0 2014/06/02 14:32:44 rhealove Exp $
class DisqusRecentComments {
   ...
   function endElement($parser, $tagName) {
       if ($tagName == "ITEM" and $this->end_count < $this->cnt) {
           ...
           if ($this->show_opt == "all") {
             printf("<div class=\"disqus-recent-comments\">%s -- %s ", $this->description, $this->creator);
           }
           ...
           if ($this->date) {
             # <pubDate>Fri, 14 Dec 2012 01:30:17 -0000</pubDate>
...
function macro_RecentComments($formatter,$value) {
  global $DBInfo;
  $this->end_count = 0;

  $xml_parser = xml_parser_create();

  $rss_parser = new DisqusRecentComments();
  ...
  # refresh rss each 5 minutes (60*5)
